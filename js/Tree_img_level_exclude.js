var draw = function() {
    ...
    function update(source) {
        ...
        console.log("n_level"+n_level);   
        console.log(source.name,source.depth); 
        console.log(source.depth<=n_level)
        ...
        if(source.depth <= n_level){
            nodes.forEach(function(d) {
                if(d.depth == n_level&&d.open){
                    collapse(d);
                }
                console.log("d.childfdfren") 
            ...
            // console.log(nodes)              
            source.children.forEach(function(d) {
                if(d.depth == source.depth&&d.open){
                    // collapse(d);
                    console.log("d.childfdfren") 
                }
