var draw = function() {
    ...
    function elbow(d) {
        var sourceX = d.source.x,
            sourceY = d.source.y + imgWidth,
            targetX = d.target.x,
            targetY = d.target.y - imgWidth;
        
          return "M" + sourceX + "," + sourceY
          + "V" + (sourceY + (targetY-sourceY))
          + "H" + targetX 
          + "V" + (sourceY + (targetY-sourceY)*1.5);          
      }
    ...
    function centerNode(source) {
        ...
        d3.select('g').transition()
            .duration(duration)
            .attr("transform", "translate(" + x + "," + y/2 + ")scale(" + scale + ")");
    ...
    function update(source) {
        ...
        var nodeEnter = node.enter().append("g")
            ...
            .attr("transform", function(d) {
                return 'translate(' + source.x0 + ',' + (source.y0 + imgWidth/2) + ')';
            })
            .on('click', click);
        ...
        nodeEnter.append("text")
            .attr("dx", -imgHeight/2)
            .attr("dy", function(d) {
                return d.children || d._children ? imgHeight : imgHeight/2;
            })            
            .attr('class', 'nodeText')
